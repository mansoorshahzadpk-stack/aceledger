...
export const Route = createFileRoute("/_authenticated/invoices/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Create, post, and review B2B invoices issued to industry clients.",
      },
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Drafts don't affect customer balance until posted</CardDescription>
        </CardHeader>
        <CardContent>
